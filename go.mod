...
require (
	...
	github.com/openshift/aws-account-operator/api v0.0.0-20260904154538-4130b43189d8
	github.com/openshift/backplane-api v0.0.0-20260903072756-97a69f906884
	github.com/openshift/backplane-cli v0.12.1
	github.com/openshift/hive/apis v0.0.0-20260430175100-52fd62d6be80
	github.com/openshift/osd-network-verifier v1.8.0
