...
// Source: pkg/services/chgm/chgm.go

// Package mock_chgm is a generated GoMock package.
package mock
...
import (
	...
	networkverifier "github.com/openshift/configuration-anomaly-detection/pkg/services/networkverifier"
)
...
// RunNetworkVerifier mocks base method.
func (m *MockService) RunNetworkVerifier(clusterID string) (networkverifier.VerifierResult, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RunNetworkVerifier", clusterID)
	ret0, _ := ret[0].(networkverifier.VerifierResult)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}

// RunNetworkVerifier indicates an expected call of RunNetworkVerifier.
func (mr *MockServiceMockRecorder) RunNetworkVerifier(clusterID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RunNetworkVerifier", reflect.TypeOf((*MockService)(nil).RunNetworkVerifier), clusterID)
}
